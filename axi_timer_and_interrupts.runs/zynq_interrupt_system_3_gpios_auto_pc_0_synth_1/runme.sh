...
HD_PWD='C:/Zynq_Book/axi_timer_and_interrupts/axi_timer_and_interrupts.runs/zynq_interrupt_system_3_gpios_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_interrupt_system_3_gpios_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_interrupt_system_3_gpios_auto_pc_0.tcl
