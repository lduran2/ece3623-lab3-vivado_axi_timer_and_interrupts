...
ISEStep( "vivado",
         "-log zynq_interrupt_system_3_gpios_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_interrupt_system_3_gpios_xbar_0.tcl" );
